...
--  Use CMD+<arrow keys> to switch between windows
--
...
vim.keymap.set('n', '<D-Down>', '<C-w><C-j>', { desc = 'Move focus to the lower window' })
vim.keymap.set('n', '<D-Up>', '<C-w><C-k>', { desc = 'Move focus to the upper window' })
